									...
									<div class="featured_slider_item active">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
													@if ($item->discount_price !== null)
													<div class="product_price text-danger" >{{$item->discount_price}} tk <span>{{$item->selling_price}}tk</span> </div>
	...
	<div class="banner_2">
		...
		<div class="banner_2_container">
			...
			<div class="owl-carousel owl-theme banner_2_slider">
				@php
					$midslide=DB::table('products')->join('categories','categories.id','products.category_id')->join('brands','brands.id','products.brand_id')->where('products.mid_slider',1)->select('categories.category_name','brands.brand_name','products.*')->orderBy('products.id','DESC')->limit(4)->get();
				@endphp

				<!-- Banner 2 Slider Item -->
				@foreach ($midslide as $item)
							...
							<div class="row fill_height">
								<div class="col-lg-4 col-md-6 fill_height">
									...
									<div class="banner_2_category">{{$item->category_name}}</div>
										...
										<div class="banner_2_title"><h5>{{$item->brand_name}}</h5></div>
										<div class="banner_2_text">product id: {{$item->product_code}}</div>
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{url($item->image_one)}}" height="400px" 
										style="width:45%"	alt=""></div>
									</div>
								</div>
							</div>
						</div>			
