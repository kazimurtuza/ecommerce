						...
						<div class="product_grid row">
							...
							<div class="product_item is_new ">
								...
								<div class="product_content">
									...
									<div class="product_name"><div><a href="{{ url('see/product/details/'.$pro->id.'/'.$pro->product_name) }}" tabindex="0">{{ $pro->product_name }}</a></div></div>
                                </div>
                            
                                   

                                     <button class="wishlist" data-id="{{$pro->id}}"><div class="product_fav"><i class="fas fa-heart"></i></div></button> 
